...
/// Api类型列表
typedef SWIFT_ENUM(NSInteger, ZHJBleApiCMD, closed) {
/// 读取消息提醒设置
...
/// 获取历史心率血压血氧记录
  ZHJBleApiCMDReadHR_BP_BOHistoryRecord = 23,
/// 开始心电
  ZHJBleApiCMDEcgStart = 24,
/// 结束心电
  ZHJBleApiCMDEcgEnd = 25,
/// 获取单次心电数据
  ZHJBleApiCMDReadEcgHistoryRecord = 26,
/// 读取个人信息
  ZHJBleApiCMDReadUserInfo = 27,
/// 写入个人信息
  ZHJBleApiCMDWriteUserInfo = 28,
/// 进入升级模式
  ZHJBleApiCMDStartFirmwareUpgrade = 29,
/// 读取设备电量
  ZHJBleApiCMDReadBatteryPower = 30,
/// 读取设备闹钟
  ZHJBleApiCMDReadAlarmClock = 31,
/// 写入闹钟
  ZHJBleApiCMDWriteAlarmClock = 32,
/// 读取设备信息
  ZHJBleApiCMDReadDeviceInfo = 33,
/// 读取设备自动睡眠时间设置
  ZHJBleApiCMDReadAutoSleepTime = 34,
/// 写入自动睡眠时间
  ZHJBleApiCMDWriteSleepSetting = 35,
/// 发送开启配对指令
  ZHJBleApiCMDEnablePair = 36,
/// 读取当前设备计步数据
  ZHJBleApiCMDReadCurrentStep = 37,
/// 读取历史计步睡眠数据记录
  ZHJBleApiCMDReadStepAndSleepHistoryRecord = 38,
/// 发送4位随机配对码
  ZHJBleApiCMDSendPairingCode = 39,
/// 关闭手环配对码页面
  ZHJBleApiCMDClosePairingCodeUI = 40,
/// 发送自定义消息
  ZHJBleApiCMDSendMessage = 41,
/// 读取设备基本配置信息
  ZHJBleApiCMDReadDeviceConfig = 42,
/// 写入设备配置
  ZHJBleApiCMDWriteDeviceConfig = 43,
/// 设置体温告警
  ZHJBleApiCMDSetTemperatureAlarmLimit = 44,
/// 设置体温自动检测
  ZHJBleApiCMDSetAutoDetectTemperature = 45,
/// 读取当前设备体温数据
  ZHJBleApiCMDReadCurrentTemperature = 46,
/// 获取手环体温高报警设置
  ZHJBleApiCMDReadTemperatureAlarmSetting = 47,
/// 获取手环自动体温采样设置
  ZHJBleApiCMDReadTemperatureTimingDetectSetting = 48,
/// 读取历史体温记录
  ZHJBleApiCMDReadTemperatureHistoryRecord = 49,
/// 读取运动模式配置
  ZHJBleApiCMDReadSportConfig = 50,
/// 写入运动模式配置
  ZHJBleApiCMDWriteSportConfig = 51,
/// 发送表盘
  ZHJBleApiCMDSendDial = 52,
/// 读取喝水提醒设置
  ZHJBleApiCMDReadDrinkWaterConfig = 53,
/// 写入运动模式配置
  ZHJBleApiCMDWriteDrinkWaterConfig = 54,
};
